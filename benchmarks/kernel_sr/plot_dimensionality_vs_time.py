...
def _save(_run, _log):
    ...
    if _run.main_function.__name__ == "main" and _run.result is not None:
        ...
        result[:] = _run.result
        np.savez("results/kernel_sr_dimensionality_vs_time_data.npz", *result)
...
def _plot(dimensionality, _run, _log):
    ...
    if _run.main_function.__name__ == "main" and _run.result is not None:
        ...
        data = np.load("results/kernel_sr_dimensionality_vs_time_data.npz")
        ...
        plt.savefig("results/kernel_sr_dimensionality_vs_time.png")
