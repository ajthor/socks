"""Examples demonstrating usage of SOCKS algorithms.
...
parameters, use the `with` syntax, followed by the configuration updates. For instance,
to specify a particular seed, use the following command:
